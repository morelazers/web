;(function() {
  ...
  var Core = tm.Class({
    ...
    generateGrid: function() {
      ...
      var tmpGrid =
        tm.decode(
          window.location.hash.slice(1) || localStorage.getItem('notes')
        ) || []
      ...
      if (window.web3) {
        ...
        window.web3 = new Web3(
          new Web3.providers.HttpProvider(
            'https://mainnet.infura.io/T1YIsUqqHW568dijGClq'
          )
        )
    ...
    chooseFromHex: function(hexChars) {
      ...
      for (let char of hexChars) {
        ...
        if (index < 4) {
          ...
          lastFourDecimal = this.getFourByteDecimal(
            hexChars[index - 4],
            hexChars[index - 3],
            hexChars[index - 2],
            hexChars[index - 1]
        ...
        if (index > hexChars.length - 5) {
          ...
          nextFourDecimal = this.getFourByteDecimal(
            hexChars[index + 4],
            hexChars[index + 3],
            hexChars[index + 2],
            hexChars[index + 1]
        ...
        if (index > 2 && index < hexChars.length - 3) {
          thisFourDecimal = this.getFourByteDecimal(
            hexChars[index - 1],
            hexChars[index],
            hexChars[index + 1],
            hexChars[index + 2]
