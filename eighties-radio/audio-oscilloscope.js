(function(root) {
  ...
  function AudioOscilloscope(canvas, options) {
    ...
    this.canvasContext.fillStyle = _result(canvasContextOptions.fillStyle) || 'rgb(255, 255, 255, 0)';
    this.canvasContext.strokeStyle = _result(canvasContextOptions.strokeStyle) || 'rgb(0, 0, 0, 0)';
  ...
  // would be good if we could pipe multiple sources into this
